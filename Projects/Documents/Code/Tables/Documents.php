...
namespace Projects\Projects\Documents\Code\Tables;
 ...
 * Documents
 *
 * @ORM\Table(name="projects_projects_documents", indexes={@ORM\Index(name="project_id_index", columns={"project_id"})})
 * @ORM\Entity
